...
import { clientSchema, invoiceSchema, productSchema } from "./schemas.ts";
...
export const ClientCollection = db.collection<clientSchema>("Clients")
export const ProductCollection = db.collection<productSchema>("Products")
export const InvoiceCollection = db.collection<invoiceSchema>("Invoices")
